...
import { FaUsers, FaCalendarAlt, FaMoneyCheck } from "react-icons/fa";
      ...
      <div className="mod-wrapper">
        <div className="mod-header resp-tabs-parent">
          <div style={styles.topbar} className="mod-animate">
            <div>
              <h1 style={styles.pageTitle}>Human Resources</h1>
...
const tabs = [
  ...
  { key: 'attendance', icon: <FaCalendarAlt />, label: 'Attendance' },
  { key: 'payroll',    icon: <FaMoneyCheck />, label: 'Payroll' },
];
